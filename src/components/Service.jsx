                    ...
                    <div className="lg:flex gap-x-[100px]">
                        <div className="">
                            <div className="flex gap-x-[30px] ">
                                <div className="lg:py-[74px] py-[37px] px-[30px] lg:px-[60px] bg-[#fff]">
                        ...
                        <div className="">
                            <h2 className='lg:text-start text-center  text-[36px] lg:text-[48px] font-Poppins font-semibold text-[#29313D]  leading-[140%]'>The hundred of <br className='lg:block hidden' /> completed works still <br className='lg:block hidden' /> counting</h2>
                            <p className='lg:text-[18px] text-[16px] lg:text-start text-center font-Nunito font mt-[20px] lg:w-[550px]'>Through strategy, design, and planning we build brand identities that connect with your Nesi. We then fine-tune a marketing plan that allows us to laser focus and target your audience through the right channels.</p>
