        ...
        <div className='bg-[#FAFAFA] mt-[-27px] relative '>
            ...
            <Container className="relative">
                <div className="lg:pt-[280px] pt-[60px]">
                    ...
                    <h3 className='lg:text-[48px] text-[36px] font-Poppins font-semibold text-[#29313D] leading-[140%] mt-[10px] lg:text-start text-center'>Connect People In<br /> Digital Life</h3>
                </div>
                <div className="absolute top-[380px] left-[500px] lg:block hidden">
