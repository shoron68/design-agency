...
const Hero = () => {
    return (
        <div className='relative ' >
            ...
            <div className="lg:mx-0 mx-[30px]">
                ...
                <Container className='lg"pt-[197px] pt-[60px] lg:pb-[297px] pb-[50px] '>
                    <div className="lg:w-[771px] mx-auto ">
                        <h1 className='lg:text-[64px] text-[35px] font-Poppins font-bold text-[#29313D] text-center leading-[130%] '>We are a full range design agency</h1>
                        <p className='lg:text-[18px] text-[16px] font-Nunito font-normal text-[#29313D] text-center lg:w-[547px] mx-auto leading-[200%] mt-[24px]'>Nam libero tempore, cum soluta nobis est eligendi optio cumque nihil impedit quo minus id quod maxime.</p>
                    </div>
            ...
            <Container>
                <div className=" lg:absolute bottom-[-140px] left-[216px] z-10 lg:mx-0 mx-[30px] lg:pb-0 pb-[100px]">

                    <div className="grid lg:grid-cols-3 grid-cols-1 lg:grid-rows-1 grid-rows-3 gap-x-[50px]">
                        <div >
                            <div className="lg:w-[450px] bg-[#fff] shadow-xl lg:shadow-none">
                        ...
                        <div >
                            <div className="lg:w-[450px] bg-[#fff] shadow-xl lg:shadow-none mt-[20px] lg:mt-0">
                                <div className="lg:ml-[30px] pt-[40px] pb-[40px]">
                                    <div className='lg:justify-staer flex justify-center'>
