...
<div className=" lg:mx-0 mx-[30px]">
    <h4 className='text-[20px] font-Poppins font-normal text-[#29313D] lg:text-start text-center'>Lets talk</h4>
    <div className="lg:flex justify-between items-center border-b-[1px] border-[#29313D] pb-[48px]">
        <h2 className='lg:text-[48px] text-[36px] lg:text-start text-center text-[#29313D] font-Poppins font-semibold leading-[140%]'>Got a project?</h2>
        <div className="flex justify-center lg:justify-start lg:mt-0 mt-[20px]">
